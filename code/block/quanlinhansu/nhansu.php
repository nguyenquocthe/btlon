...
<div class="danhmuc">
	...
	<a href="" name="tatca" >Tất Cả Nhân Viên</a><br><br>
	<a href="" name=>TRưởng Phòng</a><br><br>
	<a href="">Nhân Viên QLS</a><br><br>
	<a href="">Bảo Vệ</a><br>
...
include("../config.php");
	...
	$sql="select * from nhanvien where chucvu='trưởng phòng' or chucvu ='nhân viên'";
